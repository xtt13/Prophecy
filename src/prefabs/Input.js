...
export default class extends Player{
  ...
  checkController(){
    console.log(this.game.input.gamepad);
  ...
  addGamepadButtons(){
    if(this.pad1._rawPad.id.indexOf("360")){
      ...
      this.gamepad_buttonA = this.pad1.getButton(Phaser.Gamepad.XBOX360_A);
        ...
        this.gamepad_buttonDPadLeft.onUp.add(this.onUp, this);
        this.gamepad_buttonDPadRight.onUp.add(this.onUp, this);
        this.gamepad_buttonDPadUp.onUp.add(this.onUp, this);
        this.gamepad_buttonDPadDown.onUp.add(this.onUp, this);
